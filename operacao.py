        ...
        with zipfile.ZipFile(nome_arquivo_zip, 'w', zipfile.ZIP_DEFLATED) as zipf:
            for emp in empresas:
                ...
                for x in lanc_rateios:
                    ...
                    df_rateio['DATA'] = pd.to_datetime(df_provisorio['DATA'].iat[0])
                    ...
                    arg5 = 'A'
                    arg6 = '2.1.70'
                    arg7 = f'AA000{str(data_emissao)}{str(data_emissao)}'
                    arg45 = f'{str(data_vencimento)}'
                    arg8 = '0,00'
                    arg9 = '001'
                    ...
                    arg31 = '0'
                    arg32 = '651698'
                    arg33 = f'{str(data_emissao)}'
                    arg34 = cnpj
                    arg35 = f'{str(data_emissao)}'
                    arg36 = '153025'
                    arg37 = f'{str(data_emissao)}'
                    arg38 = '0'
                    arg39 = '1'
                    arg40 = '0'
                    arg41 = '0,00'
